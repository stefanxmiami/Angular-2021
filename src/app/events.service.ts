...
export class EventsService {
  events = [
    { name: 'Blue Ocean', id: 1, shortDescription: 'Your gift to Blue Ocean Society for Marine Conservation helps protect marine life in the Gulf of Maine and beyond.', picture: "../../assets/oPolution.jpg" },
